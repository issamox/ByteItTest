    ...
    <div class="max-w-2xl mx-auto bg-white p-6 rounded-lg shadow-lg">
        ...
        <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <input type="number" id="quantity_in_stock" name="quantity_in_stock" class="w-full mt-2 px-4 py-2 border border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500" placeholder="Enter product Qte" required value="{{ old('quantity_in_stock') }}">
            ...
            <div class="mb-4">
                ...
                <input type="number" id="minimum_threshold" name="minimum_threshold" class="w-full mt-2 px-4 py-2 border border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500" placeholder="Enter product mini threshold" required value="{{ old('minimum_threshold') }}">
