        ...
        <form action="{{ route('orders.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-3 gap-6">
                ...
                <div class="mb-4">
                    ...
                    <input type="date" id="name" name="name" class="w-full mt-2 px-4 py-2 border border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500" value="{{  old('order_date') }}">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="order_number" name="order_number" class="w-full mt-2 px-4 py-2 border border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500" readonly value="{{ $order_num  }}">
            ...
            <table class="min-w-full table-auto text-center" id="product-table">
                ...
                <tr class="product-row">
                    <td colspan="w-[20%]">
                        <select name="products[0][id]" class="product-select w-full"  required>
                    ...
                    <td class="w-[20%]"><input type="number" name="products[0][quantity]" class="quantity w-full text-center mt-2 px-4 py-2 border border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500" min="1" value="1"  required></td>
                    <td class="w-[20%]">$<span class="subtotal w-full">0.00</span></td>
            ...
            <div class="flex justify-end mt-6">
                <button type="submit" class="bg-blue-500 text-white py-2 px-6 rounded-lg hover:bg-blue-600">Create Order</button>
            </div>
        </form>
    </div>
@endsection
